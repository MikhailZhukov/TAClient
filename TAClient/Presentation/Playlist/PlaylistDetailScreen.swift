...
/// Thin wrapper view that owns a `PlaylistDetailViewModel` via `@State` so the
...
/// `TAClientApp` would call `container.makePlaylistDetailViewModel(...)`
...
struct PlaylistDetailScreen: View {
    // INVARIANT: PlaylistDetailViewModel.init must remain side-effect-free.
